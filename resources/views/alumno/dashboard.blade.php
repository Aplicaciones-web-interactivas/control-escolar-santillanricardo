...
<div class="min-h-screen bg-blue-50">
    ...
    <nav class="bg-white border-b border-blue-100 shadow-sm px-8 py-4 flex justify-between items-center">
        <div class="flex gap-6">
            <a href="{{ route('alumno.dashboard') }}" class="text-sm font-semibold text-blue-600 hover:text-blue-800">Home</a>
            <a href="{{ route('alumno.tareas') }}" class="text-sm font-semibold text-blue-600 hover:text-blue-800">Tareas</a>
        </div>
    ...
    <div class="flex items-center justify-center mt-20 p-6">
        <div class="bg-white p-8 w-full max-w-md text-center">
            ...
            <p class="text-sm text-blue-400">Panel de Alumno</p>
        </div>
    </div>
