...
<div class="bg-blue-50 min-h-screen flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-blue-100 p-8">
            ...
            <h2 class="text-2xl font-bold text-blue-800 mb-2">Crear cuenta</h2>
            <p class="text-sm text-blue-400 mb-6">Regístrate para acceder al sistema</p>

            <form method="POST" action="{{ route('register.post') }}" class="space-y-5">
                @csrf

                <div class="flex flex-col">
                    <label class="text-sm font-semibold text-blue-700 mb-1">Nombre completo</label>
                ...
                <div class="flex flex-col">
                    <label class="text-sm font-semibold text-blue-700 mb-1">Confirmar contraseña</label>
